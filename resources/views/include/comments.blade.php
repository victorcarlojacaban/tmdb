            ...
            <div class="col-md-12">
                <div class="comments">
                  <ul>
                    <li class="panel">
                      <div class="author"><i class="fa fa-user"></i>Ronnie</div>
                      <div class="date"><i class="fa fa-clock-o"></i>8 minutes ago</div>
                      <div class="text">Great, since I signed up the video goes smoothly. audio 10 and video 10, Thanks Bro.</div>
                    </li>
                    <li class="panel">
                      <div class="author"><i class="fa fa-user"></i>Nagazaki</div>
                    ...
                    <li class="panel">
                      <div class="author"><i class="fa fa-user"></i>Ronda</div>
                      ...
                      <ul>
                        <li class="panel">
                          <div class="author"><i class="fa fa-user"></i>Johnny</div>
                          <div class="date"><i class="fa fa-clock-o"></i>2 hour ago</div>
                          <div class="text">Bhoooo .. I do not like it at all</div>
                        </li>
                        <li class="panel">
                          <div class="author"><i class="fa fa-user"></i>Suresh</div>
                          <div class="date"><i class="fa fa-clock-o"></i>1 hour ago</div>
                    ...
                    <li class="panel">
                      <div class="author"><i class="fa fa-user"></i>Nina</div>
                      <div class="date">3 days ago</div>
                      <div class="text">Just Wow!!!</div>
                    </li>
                    <li class="panel">
                      <div class="author"><i class="fa fa-user"></i>Peter</div>
                    ...
                    <li class="panel">
                      <div class="author"><i class="fa fa-user"></i>Nash</div>
                      <div class="date"><i class="fa fa-clock-o"></i>9 days ago</div>
                      <div class="text">How can I watch it ?????</div>
                      <ul>
                        <li class="panel">
                          <div class="author"><i class="fa fa-user"></i>Jewel</div>
                          <div class="date"><i class="fa fa-clock-o"></i>8 days ago</div>
                          <div class="text">Did u ever read the instructions ???</div>
                        </li>
                      </ul>
                    </li>
                    <li class="panel">
                      <div class="author"><i class="fa fa-user"></i>NIca</div>
                    ...
                    <li class="panel">
                      <div class="author"><i class="fa fa-user"></i>Roko Sina</div>
                    ...
                    <li class="panel">
                      <div class="author"><i class="fa fa-user"></i>Julia</div>
                      <div class="date"><i class="fa fa-clock-o"></i>9 days ago</div>
                    ...
                    <li class="panel">
                      <div class="author"><i class="fa fa-user"></i>Nardo</div>
