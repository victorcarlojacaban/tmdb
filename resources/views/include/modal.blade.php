<div class="modal fade dcma" style="color:black" tabindex="-1" role="dialog" aria-labelledby="dcma" aria-hidden="true">
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body" style="text-align:justify;">
        ...
        <ul style="text-align: left;">
          ...
          <li>A statement that the information in the written notice is accurate, and under penalty of perjury, that you are the owner
, or an agent authorized to act on behalf of the owner of an exclusive right that is allegedly infringed."</li>
...
<div class="modal fade contact" tabindex="-1" role="dialog" aria-labelledby="contact" aria-hidden="true">
  <div class="modal-dialog">
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title text-center">About us <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button></h3>
      </div>
      <div class="panel-body" style="text-align:justify;">
        
          <div class="panel-body" style="text-align: justify">
          <p>
            <strong>Mediastreamm</strong> is an online platform for film fanatics to watch the latest TV Shows and Movies. The video sources are extensive that across all categories, such as Action, Crime, Comedy and History.You can easily find what you want. The Videos are be updated daily so that you can search and discovery the latest Movies and TV shows free online. Unlike other sites, you can watch videos without signing up.

            Mediastreamm is free to use and accessible via Desktop and Mobile Web. Just choose Mediastreamm to get your favorite TV Shows and Movies!
            <br/> <br/>
            <b>Contact us</b><br/>
            mediastreamm@hotmail.com
          </p>
          </div>
